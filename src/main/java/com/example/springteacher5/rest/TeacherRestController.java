...
import com.example.springteacher5.validator.TeacherInsertValidator;
import com.example.springteacher5.validator.TeacherUpdateValidator;
...
//            throw e;
    ...
    public ResponseEntity<TeacherReadOnlyDTO> getTeacher(@PathVariable("teacherID") Long id) {
        Teacher teacher;
    ...
    public ResponseEntity<TeacherReadOnlyDTO> addTeacher(@Valid @RequestBody TeacherInsertDTO dto, BindingResult bindingResult) {
        ...
        try {
            Teacher teacher = teacherService.insert(dto);
    ...
    public ResponseEntity<TeacherReadOnlyDTO> updateTeacher(@PathVariable("id") Long id, @Valid @RequestBody TeacherUpdateDTO dto, BindingResult bindingResult) {
        ...
        try {
            ...
            Teacher teacher = teacherService.update(dto);
